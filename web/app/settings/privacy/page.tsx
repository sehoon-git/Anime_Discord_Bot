...
export default async function PrivacySettingsPage() {
  ...
  return <main className="site-wash min-h-screen px-6 py-12 text-[#493647]"><section className="mx-auto max-w-3xl">
    <p className="text-sm font-semibold text-[#d45d91]">Voice With AI</p><h1 className="mt-3 text-4xl font-bold">{ko ? "설정" : "Settings"}</h1><p className="mt-3 text-sm text-[#806579]">{ko ? "서비스 화면과 AI 응답에 사용할 환경을 설정할 수 있습니다." : "Choose the preferences used by the website and AI responses."}</p>
