...
const copy = {
  ...
  ko: {
    ...
    story: [
      { eyebrow: "기억하는 대화", title: "당신과의 추억을 기억하는 캐릭터", description: "대화 속 작은 취향과 이야기를 기억해 다음 인사가 조금 더 익숙하고 자연스럽게 이어집니다.", note: "장기기억", bubble: "조용한 밤을 좋아한다고 했었죠?" },
    ...
    <section className="relative isolate mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col items-center justify-center overflow-hidden px-6 pb-16 pt-16 text-center">
      ...
      <div className="hero-scene relative z-10 mt-[4.5rem] w-full max-w-4xl" aria-label={text.sceneLabel}>
        ...
        <div className="hero-window relative z-10">
          <div className="flex items-center justify-between border-b border-[#f0d7e5] px-5 py-4"><div className="flex items-center gap-3"><span className="relative h-9 w-9 overflow-hidden rounded-2xl border border-white/50"><Image src="/seline-icon-v2.png" alt="" fill sizes="36px" className="object-cover object-[50%_46%]" /></span><div className="text-left"><p className="text-sm font-bold text-[#684b60]">Seline</p><p className="text-xs text-[#ad8fa1]">{text.talking}</p></div></div><span className="live-dot" aria-label="Online" /></div>
            ...
            <div className={`home-story-scene home-story-scene-${index + 1}`} aria-hidden="true">
              ...
              {index === 1 ? (
                <div className="home-voice-panel">
                  ...
                  <div className="mt-6 flex items-center gap-4"><span className="relative h-16 w-16 overflow-hidden rounded-3xl border border-white/25 shadow-[0_12px_26px_rgba(211,123,177,0.3)]"><Image src="/seline-icon-v2.png" alt="" fill sizes="64px" className="object-cover object-[50%_46%]" /></span><div><p className="font-extrabold text-white">Seline</p><p className="mt-1 text-sm text-[#d7bfd3]">{story.bubble}</p></div></div>
                ...
                <div className="home-story-panel">
                  <div className="flex items-center gap-3 border-b border-white/10 px-5 py-4"><span className="relative h-9 w-9 overflow-hidden rounded-2xl border border-white/25"><Image src="/seline-icon-v2.png" alt="" fill sizes="36px" className="object-cover object-[50%_46%]" /></span><span className="text-sm font-bold text-white">Seline</span><span className="ml-auto h-2.5 w-2.5 rounded-full bg-[#6fd3b0] shadow-[0_0_0_5px_rgba(111,211,176,0.12)]" /></div>
