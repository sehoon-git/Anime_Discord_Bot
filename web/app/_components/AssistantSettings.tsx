  ...
  return (
    <section className="mt-6 rounded-3xl border border-[#f0d7e5] bg-white/80 p-5 shadow-[0_16px_45px_rgba(198,135,169,0.1)]">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-sm font-semibold">음성 스타일<select value={value.voice_style} onChange={(event) => set("voice_style", event.target.value as Preferences["voice_style"])} className="mt-2 w-full rounded-xl border p-3"><option value="expressive">표현형</option><option value="fast">빠른 응답</option></select></label>
